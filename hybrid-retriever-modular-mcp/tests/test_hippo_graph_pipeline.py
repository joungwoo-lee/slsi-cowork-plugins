...
class TestHippoGraphPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.cfg.hipporag = HippoRAGConfig()
    ...
    @patch("retriever.hipporag.query.search")
    ...
    def test_pipeline_execution(self, mock_graph, mock_emb_client, mock_ensure, mock_qdrant, mock_vsearch, mock_fetch_chunks, mock_fts_search, mock_hippo_search):
        ...
        profile = profiles.get("hippo_graph_rrf")
